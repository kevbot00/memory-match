class Card {
  constructor( imgNum, clickCallback ){
    ...
    this.backImg.src = './v1.5/images/back.jpg';
    this.cardContainer = {}
  }
  ...
  render(){
    ...
    const backImg = $( this.backImg).addClass('back').attr('src', './v1.5/images/back.jpg' ).click( { card: this, img: this.frontImg }, this.clickCallback );
